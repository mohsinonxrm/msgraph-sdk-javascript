...
export { DataverseRequestOptions, PageCollection, PageIterator, PageIteratorCallback } from "./tasks/PageIterator";

export { Client } from "./Client";
export { CustomAuthenticationProvider } from "./CustomAuthenticationProvider";
export { DataverseError } from "./DataverseError";
export { DataverseClientError } from "./DataverseClientError";
export { DataverseRequest, URLComponents } from "./DataverseRequest";
...
export { DataverseRequestCallback } from "./IDataverseRequestCallback";
